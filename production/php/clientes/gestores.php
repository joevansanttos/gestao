        ...
        <div class="right_col" role="main">
          <div class="">
            <div class="page-title">
              <div class="title_left"><h3>Gestores</h3></div>
                        ...
                        <table id="tabela" class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><?=$gestor['tel']?></td>
                              <td align="center">
                                <a href="../forms/form-altera-gestor.php?id_gestor_dep=<?=$gestor['id_gestor_dep']?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                                <a href="../remove/remove-gestor_dep.php?id_gestor_dep=<?=$gestor['id_gestor_dep']?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button></a>
                              </td>
