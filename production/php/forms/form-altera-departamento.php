...
<?php
  ...
  $departamento = buscaDepartamento($conexao, $id_departamento);
	            ...
	            <div class="x_content">
	            	<div class="row">
	            	  <div class="col-md-12 col-sm-12 col-xs-12">
	            	  	<form action="../altera/altera-departamento.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
	            	  	 ...
	            	  	 <div class="form-group">
	            	  	   ...
	            	  	   <div class="col-md-6 col-sm-6 col-xs-12">
	            	  	     <input type="text" id="nome" name="nome"  value="<?=$departamento['nome']?>" required="required" class="form-control col-md-7 col-xs-12">
	            	  	   </div>
	            	  	 </div>	            	  	   	  	             
