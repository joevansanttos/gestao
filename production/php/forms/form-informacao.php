	            ...
	            <div class="x_content">
	            	<div class="row">
	            	  <div class="col-md-12 col-sm-12 col-xs-12">
	            	  	<form action="../adiciona/adiciona-informacao.php" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
		            	  	...
		            	  	<div class="form-group">
		            	  	  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nome">Informações Gerais<span class="required">*</span>
		            	  	  </label>
		            	  	  <div class="col-md-6 col-sm-6 col-xs-12">
