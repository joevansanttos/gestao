	            ...
	            <div class="x_content">
	            	<div class="row">
	            	  <div class="col-md-12 col-sm-12 col-xs-12">
	            	  	<form action="../adiciona/adiciona-pi.php" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
		            	  	...
		            	  	<div class="form-group">
		            	  	   ...
		            	  	   <div class="col-md-6 col-sm-6 col-xs-12">
		            	  	     <input  data-inputmask="'mask' : '*****'" type="text"  id="cod_pi" name="cod_pi" required="required" class="form-control col-md-6 col-xs-12">
		            	  	   </div>
		            	  	</div>  	             
